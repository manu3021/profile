...
/* profiles/multipurpose_corporate_profile/modules/simple_gmap/templates/simple-gmap-output.html.twig */
class __TwigTemplate_4475f0acef291fb074ae9277d31ddc12599a8f69ae3451dde3908d1791312e48 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        if ((isset($context["include_map"]) ? $context["include_map"] : null)) {
            ...
            echo "&amp;iwloc=";
            echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->renderVar((((isset($context["information_bubble"]) ? $context["information_bubble"] : null)) ? ("A") : ("near"))));
            echo "&amp;t=";
...
";
    ...
    {
        return "profiles/multipurpose_corporate_profile/modules/simple_gmap/templates/simple-gmap-output.html.twig";
    }
    ...
    {
        return array (  104 => 41,  102 => 40,  86 => 38,  84 => 37,  68 => 34,  65 => 33,  63 => 32,  45 => 30,  43 => 29,);
    }
}
/* {#*/
/* /***/
...
/* #}*/
/* {% if include_map %}*/
/*   <iframe width="{{ width }}" height="{{ height }}" frameborder="0" style="border:0" src="https://maps.google.com/maps?hl={{ langcode }}&amp;q={{ url_suffix }}&amp;iwloc={{ information_bubble ? 'A' : 'near' }}&amp;t={{ map_type }}&amp;z={{ zoom }}&amp;output=embed"></iframe>*/
/* {% endif %}*/
/* {% if include_static_map %}*/
/*   <div class="simple-gmap-static-map">*/
/*     <img src="http://maps.googleapis.com/maps/api/staticmap?size={{ width }}x{{ height }}&amp;zoom={{ zoom }}&amp;language={{ langcode }}&amp;maptype={{ static_map_type }}&amp;markers=color:red|{{ url_suffix }}&amp;sensor=false" />*/
/*   </div>*/
/* {% endif %}*/
/* {% if include_link %}*/
/*   <p class="simple-gmap-link"><a href="https://maps.google.com/maps?q={{ url_suffix }}&amp;hl={{ langcode }}&amp;iwloc={{ information_bubble ? 'A' : 'near' }}&amp;t={{ map_type }}&amp;z={{ zoom }}" target="_blank">{{ link_text }}</a></p>*/
/* {% endif %}*/
